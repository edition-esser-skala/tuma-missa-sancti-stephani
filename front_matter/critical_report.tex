...
\title{Missa Sancti Stephani}
\shorttitle{Missa S. Stephani}
\subtitle{(A-Wn Mus.Hs.18992)}
\scoring{S, A, T, B (solo), S, A, T, B (coro), 2 trb, 2 vl, b, org}
\maketitle
...
\textit{First version, October 2021}
...
This edition bases upon a copy in the Austrian National Library. The digital version of the manuscript is available at \url{http://data.onb.ac.at/rec/AC14297554} (siglum Mus.Hs.18992; no RISM entry).
...
\begin{longtable}{lll L{10cm}}
  ...
  \midrule \endhead
  3 & 20 & org     & 2nd half of bar in Ms: A4–e″4 \\
    & 29 & vl 1    & last sixteenth in Ms: g′16 \\
    & 32 & trb 2   & 2nd quarter in Ms: e′8.–e′16 \\
  6 & 9  & vl 1, 2 & 5th eighth in Ms: a′8 \\
  \bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/tuma-missa-sancti-stephani}. Your help will be greatly appreciated.

\bigskip
\textit{Koppl, October 2021\\
